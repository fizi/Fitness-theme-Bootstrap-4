...
$GALLERY_TEMPLATE['list']['item'] = '
    ...
    <div class="col-lg-4 col-md-6 grid-item mb-4">
      <div class="grid-image rounded p-3 shadow-sm">
        <img class="w-100 card-img-top" src="{GALLERY_THUMB=w=1000&h=700&thumburl}" />
        <div class="grid-image-title p-4 card-img-bottom">{GALLERY_CAPTION}</div>
      </div>
    </div>
';
...
$GALLERY_TEMPLATE['cat']['item'] = '
    <div class="col-lg-6 col-md-6 mb-4">
      <div class="gallery-cat-image rounded p-3 shadow-sm">
	    {GALLERY_CAT_THUMB=aw=1000&ah=700}
	    <div class="cat-image-title p-4 card-img-bottom">{GALLERY_CAT_TITLE}</div>
        <div class="cat-image-description">{GALLERY_CAT_DESCRIPTION}</div>
      </div>
    </div>
';
