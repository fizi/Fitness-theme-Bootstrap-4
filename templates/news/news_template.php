...
<div class="default-news-item">
  <div class="row">
    <div class="col-md-6">
      <div class="default-news-images-main">
        {SETIMAGE: w=900&h=675&crop=1}
        <a href="{NEWS_URL}">{NEWSIMAGE: item=1}</a>
        <div class="default-news-category">{NEWSCATEGORY}</div>
      </div>
    </div>
    <div class="col-md-6">
      <h2 class="default-news-title">{NEWS_TITLE: link=1}</h2>
      <div class="default-news-info">{NEWSAUTHOR}&nbsp;&nbsp;|&nbsp;&nbsp;{NEWSDATE=short}&nbsp;&nbsp;|&nbsp;&nbsp;{NEWSCOMMENTCOUNT}&nbsp;&nbsp;{NEWS_COMMENT_LABEL}&nbsp;&nbsp;|&nbsp;&nbsp;<i class="far fa-eye"></i>&nbsp;{HITS_COUNTER: multi=1}</div>
      <div class="default-news-body">{NEWS_BODY}</div>
      <div class="default-news-extended"><a href="{NEWSURL}"><i class="fas fa-angle-double-right"></i></a></div>
    </div>
  </div>
</div> 
';
...
<h2 class="related-news-title">'.LAN_RELATED.'</h2>
<div class="row">';
