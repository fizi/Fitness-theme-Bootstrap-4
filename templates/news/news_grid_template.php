...
//  fizi - This News Grid for Latest News Items - 4 News  
$NEWS_GRID_TEMPLATE['homepage-latestnews']['start'] = '
<div class="homepage-latestnews">
  <div class="row">
';
    ...
    <div class="col-md-4" data-aos="zoom-in">
      <div class="homepage-latestnews-item matchHeigh">                             
        ...
        <div class="homepage-latestnews-item-image">
          <a href="{NEWS_URL}">{NEWS_IMAGE: link=1}</a>
        </div>
        <div class="homepage-latestnews-item-text">  
          <div class="homepage-latestnews-item-date">
            <div class="homepage-latestnews-item-date-day">{NEWS_DATE=dd}</div>
            <div class="homepage-latestnews-item-date-month">{NEWS_DATE=M}</div>
          </div> 
          <div class="homepage-latestnews-item-title">{NEWS_TITLE: link=1}</div> 
        </div> 
