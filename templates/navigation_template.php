...
<ul class='navbar-nav mr-auto {NAV_CLASS}'>
";
...
$NAVIGATION_TEMPLATE['main']['item_active'] = "
  <li class='nav-item active'>
    <a class='nav-link' role='button' href='{NAV_LINK_URL}' title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a>
  </li>
";
...
$NAVIGATION_TEMPLATE['main']['item_submenu'] = "
  <li class='nav-item dropdown'>
    <a id='dropdownMenu-{NAV_LINK_ID}' href='#' role='button' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false' class='nav-link dropdown-toggle' title='{NAV_LINK_DESCRIPTION}'>
...
$NAVIGATION_TEMPLATE['main']['item_submenu_active'] = '
  <li class="nav-item dropdown active {NAV_LINK_IDENTIFIER}">
    <a id="dropdownMenu-{NAV_LINK_ID}" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" class="nav-link dropdown-toggle">
	  {NAV_LINK_ICON}{NAV_LINK_NAME}
	</a>
	{NAV_LINK_SUB}
  </li>
...
<ul aria-labelledby="dropdownMenu-{NAV_LINK_PARENT}" class="dropdown-menu submenu-start submenu-level-{NAV_LINK_DEPTH}">
';
...
$NAVIGATION_TEMPLATE['main']['submenu_loweritem'] = '
      <li class="dropdown-submenu">
        <a id="dropdownMenu-{NAV_LINK_ID}" class="dropdown-item dropdown-toggle" href="{LINK_URL}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{LINK_NAME}</a>
		{LINK_SUB}
	  </li>
';
...
<div class='navbar-nav {NAV_CLASS}'>
";
$NAVIGATION_TEMPLATE['main-alt']['item'] = "
  <a class='nav-link' href='{NAV_LINK_URL}' {NAV_LINK_OPEN} title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a>
";
$NAVIGATION_TEMPLATE['main-alt']['item_active'] = "
  <a class='nav-link active' href='{NAV_LINK_URL}' {NAV_LINK_OPEN} title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a>
";
$NAVIGATION_TEMPLATE['main-alt']['end'] = '
</div>
';
...
$NAVIGATION_TEMPLATE['side']['item_active'] = "
  <li class='list-group-item active'><a href='{NAV_LINK_URL}' title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a></li>
";
...
<li class='list-group-item disabled'>{NAV_LINK_ICON}{NAV_LINK_NAME}{NAV_LINK_SUB}</li>
";
$NAVIGATION_TEMPLATE['side']['item_submenu_active'] = "
<li v>{NAV_LINK_ICON}{NAV_LINK_NAME}{NAV_LINK_SUB}</li>
";
...
<li class='list-group-item active'><a href='{NAV_LINK_URL}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a></li>
";
...
<div class='list-group {NAV_CLASS}' >
";

$NAVIGATION_TEMPLATE['side-alt']['item'] = "
  <a class='list-group-item list-group-item-action' href='{NAV_LINK_URL}' {NAV_LINK_OPEN} title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a>
";

$NAVIGATION_TEMPLATE['side-alt']['item_active'] = "
  <a class='list-group-item list-group-item-action active' href='{NAV_LINK_URL}' title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a>
";

$NAVIGATION_TEMPLATE['side-alt']['end'] = '
</div>
';

$NAVIGATION_TEMPLATE['side-alt']['item_submenu'] = "
<a class='list-group-item list-group-item-action disabled'> {NAV_LINK_ICON}{NAV_LINK_NAME}</a>
{NAV_LINK_SUB}
";
$NAVIGATION_TEMPLATE['side-alt']['submenu_item'] = "
<a class='list-group-item list-group-item-action' href='{NAV_LINK_URL}' {NAV_LINK_OPEN}>{NAV_LINK_ICON}{NAV_LINK_NAME}</a>
";
$NAVIGATION_TEMPLATE['side-alt']['submenu_item_active'] = "
<a class='list-group-item list-group-item-action active' href='{NAV_LINK_URL}' {NAV_LINK_OPEN}>{NAV_LINK_ICON}{NAV_LINK_NAME}</a>
";
...
$NAVIGATION_TEMPLATE['footer']['item_active'] = "
  <li class='nav-item active' {NAV_LINK_OPEN}>
	<a class='nav-link' href='{NAV_LINK_URL}' title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a>
  </li>";
...
$NAVIGATION_TEMPLATE['footer']['submenu_item'] = "
  <a class='dropdown-item' href='{NAV_LINK_URL}' {NAV_LINK_OPEN} title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a>
";
$NAVIGATION_TEMPLATE['footer']['submenu_item_active'] = "
  <a class='dropdown-item active' href='{NAV_LINK_URL}' {NAV_LINK_OPEN} title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a>
";
...
";
$NAVIGATION_TEMPLATE["footer-alt"]["item"] = "
  <a class='nav-link' href='{NAV_LINK_URL}' {NAV_LINK_OPEN} title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a>
";
$NAVIGATION_TEMPLATE["footer-alt"]["item_active"] = "
  <a class='nav-link active' href='{NAV_LINK_URL}' title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a>
";
